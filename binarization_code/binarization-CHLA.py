...
data_dir = 'smb://rc-fs/chip-lacava/Groups/CHLA-ED/preprocessed-data-Aug-2025'
filename = 'preprocessed_data_with_triage_vitals.csv'
...
def calculate_systolic_bp_diff_pals(data_matrix):
    ...
    data_matrix = data_matrix.copy()
    systolic_bp = data_matrix['triage_systolic_bp']
