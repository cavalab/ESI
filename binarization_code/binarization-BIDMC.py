...
file_path_vitals = os.path.join(data_dir, filename_vitals)

# Load binarized data
data = pd.read_csv(file_path_vitals)
...
data_bin['triage_SpO2_very_low'] = (data['Triage_SpO2'] == 'very_low').astype(int)
data_bin['triage_SpO2_low'] = (data['Triage_SpO2'] == 'low').astype(int)
data_bin['triage_SpO2_unknown'] = (data['Triage_SpO2'] == 'nan').astype(int)
...
# Save binarized data
data_bin.to_csv('preprocessed_BIDMC.csv')
