...
mkdir -p data/from-r
ln -s \
    /Volumes/chip-lacava/Groups/BCH-ED/reprocessing-bill/preprocessed-visits.csv \
    data/from-r/BCH.csv

ln -s \
    /Volumes/chip-lacava/Public/physionet.org/files/mimic-iv-ed/2.2/disparities/preprocessed-visits.csv \
    data/from-r/BIDMC-visits.csv
ln -s \
    /Volumes/chip-lacava/Public/physionet.org/files/mimic-iv-ed/2.2/disparities/triage.csv  \
...
ln -s \
    /Volumes/chip-lacava/Groups/CHLA-ED/preprocessed-bill/preprocessed_data_with_triage_vitals.csv \
